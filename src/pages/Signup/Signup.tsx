import { ThemeProvider, CssBaseline, Box, Container, Paper, Stack, Typography } from "@mui/material";
...
export default function Signup() {
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <Box className="signup" sx={{ py: 8 }}>
                <Container maxWidth="sm">
                    <Paper className="signup__card" sx={{ p: 4 }}>
